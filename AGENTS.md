# AGENTS.md — working on mcp2cli (Rust)

Guidance for coding agents and humans extending this repo. Prefer this file plus [README.md](README.md) and [`.cursor/skills/mcp2cli/`](.cursor/skills/mcp2cli/) over inventing new CLI surfaces.
...
- `--agent` / `MCP2CLI_AGENT=1`: JSON; search ⇒ names + `--top 20`; else brief; spool default 64KiB.
...
- Agent skill: `.cursor/skills/mcp2cli/` (index description should match v4 + session RAM behavior).
...
- Prefer small, focused commits; do not commit secrets or unrelated LICENSE/docs drive-bys unless requested.
